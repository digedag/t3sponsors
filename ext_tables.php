...
tx_rnbase_util_Extensions::addPiFlexFormValue('tx_t3sponsors','FILE:EXT:'.$_EXTKEY.'/Configuration/Flexform/flexform_'.(tx_rnbase_util_TYPO3::isTYPO70OrHigher() ? 'main' : '62').'.xml');
