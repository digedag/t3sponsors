...
if(tx_rnbase_util_TYPO3::isTYPO60OrHigher()) {
	...
	$TCA['tx_t3sponsors_companies']['columns']['logo'] = tx_rnbase_util_TSFAL::getMediaTCA('logo', array(
			'label' => 'LLL:EXT:t3sponsors/locallang_db.xml:tx_t3sponsors_companies.logo',
			'config' => array('size' => 1, 'maxitems' => 1),
	));
	$TCA['tx_t3sponsors_companies']['columns']['pictures'] = tx_rnbase_util_TSFAL::getMediaTCA('pictures');
}
