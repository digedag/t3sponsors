...
class tx_t3sponsors_search_Sponsor extends tx_rnbase_util_SearchBase
{
    ...
    protected function getTableMappings()
    {
        ...
        tx_rnbase_util_Misc::callHook('t3sponsors', 'search_Sponsor_getTableMapping_hook', array(
    ...
    protected function getJoins($tableAliases)
    {
        ...
        // Hook to append other tables
        tx_rnbase_util_Misc::callHook('t3sponsors', 'search_Sponsor_getJoins_hook', array(
            'join' => &$join,
